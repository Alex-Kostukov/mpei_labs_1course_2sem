...
procedure TFormOneDirectionList.N1Click(Sender: TObject);
  var s : string;
begin
s := 'Разработать программу для работы с однонаправленным и двунаправленным списками из элементов, попадающих диапазон от -20 до 50 и упорядоченных следующим образом: сначала нечетные, затем четные. Удалять нечетные элементы.';
...
procedure TFormOneDirectionList.N6Click(Sender: TObject);
begin
Close;
end;
